...
const USER_PROFILE_DATA = {
  ...
  recentActivity: [
    ...
    {
      title: "Solved Longest Substring Without Repeating Characters",
      status: "Solved",
      date: "1 week ago",
    },
      ...
      <section className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <StatCard
            ...
            value={`${submissionAccuracy.toFixed(2)}%`}
          />
...
const SkillCard: React.FC<{ topic: string; solved: number }> = ({
  topic,
  solved,
}) => {
  return (
...
const LanguageCard: React.FC<{ language: string; solved: number }> = ({
  language,
  solved,
}) => {
  return (
