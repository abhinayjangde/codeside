...
```
2. Update the mount path in the ``apps/web/.env``
3. Update the ``##YOUR_LOCAL_PATH_TO_PROBLEMS_DIR##`` in the `.env` file which is resides in same level of your `docker-compose.yml` file
